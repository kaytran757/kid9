import { Sparkles, Smile, Ear, Heart } from 'lucide-react';
...
const outcomes: Outcome[] = [
  {
    icon: Smile,
    title: 'Tự tin nói tiếng Anh',
    description: 'Con mạnh dạn chào hỏi, giới thiệu bản thân và trả lời cô bằng tiếng Anh.',
  ...
  },
  {
    icon: Ear,
    title: 'Phát âm chuẩn',
    description: 'Con nghe và bắt chước âm thanh tiếng Anh đúng ngay từ những từ đầu tiên.',
    badgeClass: 'bg-blush-300/70 text-blush-600',
    tilt: 'rotate-[1.5deg]',
  },
  {
    icon: Heart,
    title: 'Ham học, ham chơi',
    description: 'Con thích giờ học tiếng Anh, chủ động hát và kể chuyện bằng tiếng Anh ở nhà.',
